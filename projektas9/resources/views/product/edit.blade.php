        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{route('product.update', [$product])}}" enctype="multipart/form-data"> {{-- bet koki faila uzkoduoja kaip teksta--}}
                            @csrf
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="title" type="text" class="form-control" value={{$product->title}} name="title" required autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="description" type="text" class="form-control" value={{$product->description}} name="description" required autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="price" type="number" class="form-control" value={{$product->price}} name="price" required autofocus>
